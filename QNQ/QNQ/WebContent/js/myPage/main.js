...
(function($) {
	...
	var $window = $(window), $body = $('body'), $wrapper = $('#wrapper'), $main = $('#main'), $panels = $main
			.children('.panel'), $nav = $('#nav'), $nav_links = $nav
			.children('a');
	...
	$window.on('hashchange', function(event) {
		...
		// Set max/min height.
		$main.css('max-height', $main.height() + 'px').css('min-height',
				$main.height() + 'px');
		...
		setTimeout(function() {
			...
			$main.css('max-height', $panel.outerHeight() + 'px').css(
	...
	if (browser.name == 'ie') {
		...
		$('.panel.intro').each(
				function() {
					...
					var $pic = $(this).children('.pic'), $img = $pic
							.children('img');
