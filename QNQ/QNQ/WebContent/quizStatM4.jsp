...
<body>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			type : 'bar',
			data : {
				labels : [ '1번 : <%=getQuizStat.getQuizM1()%>명', '2번 : <%=getQuizStat.getQuizM2()%>명', '3번 : <%=getQuizStat.getQuizM3()%>명', '4번 : <%=getQuizStat.getQuizM4()%>명', ],
						datasets : [ {
							label : '통계',
							data : [<%=getQuizStat.getQuizM1()%>,<%=getQuizStat.getQuizM2()%>,<%=getQuizStat.getQuizM3()%>,<%=getQuizStat.getQuizM4()%> ],
