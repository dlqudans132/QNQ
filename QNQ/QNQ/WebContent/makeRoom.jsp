...
<body>
	...
	if (userID == null) {
		...
		script.println("swal ('방 생성' , '로그인이 필요한 기능입니다..', {");
	...
	<div id="form-div">
		<p class="triangle">방 생성하기</p>

		<form class="form" id="form1" action="makeRoomAction.jsp"
			method="post">
			<p class="email">
				<input name="roomTitle" type="text"
					class="validate[required,custom[email]] feedback-input" id="email"
					placeholder="방 제목을 입력하세요." style="padding-left: 0px;" />
			</p>
			<p class="email">
			...
			<div class="submit">
				<input type="submit" value="생성" id="button-blue" />
				<div class="ease"></div>
			</div>
		</form>
	</div>
