...
<body>
	...
	<div id="form-div">
		<p class="triangle">5지선다 퀴즈 생성</p>
		<h2>퀴즈 제목</h2>
		<form class="form" id="form1" action="makeQuizActionM5.jsp" method="post">
			<p class="email">
			...
			<p class="name5">
				<input name="quizSelect5" type="text"
					class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
					placeholder="보기 5" id="name" style="padding-left: 0px;" />
			</p>
			<div class="submit">
