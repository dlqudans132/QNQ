...
<body>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			type : 'bar',
			data : {
				labels : [ '1번 : <%=getQuizStat.getQuizM1()%>명', '2번 : <%=getQuizStat.getQuizM2()%>명', '3번 : <%=getQuizStat.getQuizM3()%>명', ],
				datasets : [ {
					label : '# of Votes',
					data : [<%=getQuizStat.getQuizM1()%>,<%=getQuizStat.getQuizM2()%>,<%=getQuizStat.getQuizM3()%> ],
	...
	<div class="wi">
		<a class="button"
			href="quizStatAction.jsp?quizNumber=<%=quizNumber%>&roomNumber=<%=roomNumber%>">새로고침</a>
